...
class Cuboidal_Body(ConceptTemplate):
    def __init__(
        ...
        middle_x = (
            top_size[0] * thickness[1] / height[0]
            + bottom_size[0] * (height[0] - thickness[1]) / height[0]
        )
        middle_z = (
            top_size[1] * thickness[1] / height[0]
            + bottom_size[1] * (height[0] - thickness[1]) / height[0]
        )
        ...
        self.top_mesh = Rectangular_Ring(
            ...
            top_size[1] - thickness[2] * 2,
            [0, 0],
            middle_x,
            middle_z,
            middle_x - thickness[0] * 2,
            middle_z - thickness[2] * 2,
            top_bottom_offset=[
                top_bottom_offset[0] - middle_offset_x,
...
class Fourfold_Cover(ConceptTemplate):
    def __init__(
        ...
        # Record Parameters
        self.has_cover = [round(item) for item in has_cover]

...
class Prismatic_Body(ConceptTemplate):
    def __init__(self, outer_size, inner_size, position=[0, 0, 0], rotation=[0, 0, 0]):
        ...
        self.bottom_mesh = Cuboid(
            bottom_height,
            middle_radius * np.sqrt(2),
            middle_radius * np.sqrt(2),
            outer_size[1] * np.sqrt(2),
            outer_size[1] * np.sqrt(2),
        ...
        self.top_mesh = Rectangular_Ring(
            inner_size[2],
            outer_size[0] * np.sqrt(2),
            outer_size[0] * np.sqrt(2),
            inner_size[0] * np.sqrt(2),
            inner_size[0] * np.sqrt(2),
...
class Trifold_Handle(ConceptTemplate):
    def __init__(
        ...
        top_mesh_position = [
            ...
            - vertical_length[0] * np.sin(vertical_rotation[0]) / 2,
        ...
        bottom_mesh_position = [
            -vertical_separation[0] / 2
            - vertical_length[1] * np.sin(vertical_rotation[1]) / 2,
...
class Round_U_Handle(ConceptTemplate):
    def __init__(
        ...
        left_mesh_position = [vertical_separation[0] / 2, vertical_length[0] / 2, 0]
        self.left_mesh = Cylinder(
            vertical_length[0], inner_radius[0], position=left_mesh_position
        )
        ...
        right_mesh_position = [-vertical_separation[0] / 2, vertical_length[0] / 2, 0]
        self.right_mesh = Cylinder(
            vertical_length[0], inner_radius[0], position=right_mesh_position
        )
...
class Flat_U_Handle(ConceptTemplate):
    def __init__(
        ...
        left_mesh_position = [vertical_separation[0] / 2, vertical_size[1] / 2, 0]
        ...
        right_mesh_position = [-vertical_separation[0] / 2, vertical_size[1] / 2, 0]

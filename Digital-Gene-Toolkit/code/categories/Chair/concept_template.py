...
class Ladder_back(ConceptTemplate):
    def __init__(
        ...
        for i in range(3 + round(number_of_subs[0])):
            mesh_rotation = [back_rotation[0], 0, 0]
            if i < 2:
                flag = 1 if i == 1 else -1
                vertical_position = [
                    flag * main_vertical_separation[0] / 2,
                    main_vertical_piece_size[1] / 2 * np.cos(back_rotation[0]),
                    0,
                ]
                self.mesh = Cuboid(
                    self.main_vertical_piece_size[1],
                    self.main_vertical_piece_size[0],
                ...
                horizontal_position = [
                    0,
                    (main_vertical_piece_size[1] + main_horizontal_piece_size[1] / 2)
                    * np.cos(back_rotation[0]),
                    (main_vertical_piece_size[1] + main_horizontal_piece_size[1])
                    / 2
                    * np.sin(back_rotation[0]),
                ]
                self.mesh = Cuboid(
                    self.main_horizontal_piece_size[1],
                    self.main_horizontal_piece_size[0],
                ...
                sub_position = [
                    0,
                    (
                        main_vertical_piece_size[1] / 2
                        + sub_offset[0]
                        - (i - 3) * interval_between_subs[0]
                    )
                    * np.cos(back_rotation[0]),
                    (sub_offset[0] - (i - 3) * interval_between_subs[0])
                    * np.sin(back_rotation[0]),
                ]
                self.mesh = Cuboid(
...
class Latice_back(ConceptTemplate):
    def __init__(
        ...
        for i in range(4 + round(number_of_subs[0])):
            mesh_rotation = [back_rotation[0], 0, 0]
            if i < 2:
                flag = 1 if i == 1 else -1
                vertical_position = [
                ...
                self.mesh = Cuboid(
                    ...
                    self.main_vertical_separation[0] - self.main_vertical_piece_size[0],
                    self.sub_horizontal_piece_size[1],
                    position=sub_horizontal_position,
                    rotation=mesh_rotation,
                )
            else:
                sub_vertical_position = [
                    sub_vertical_offset[0] + (i - 4) * interval_between_subs[0],
                    (
                        main_vertical_piece_size[1] * 3 / 2
                        + sub_horizontal_offset[0]
                        + sub_horizontal_piece_size[0] / 2
                    )
                    / 2
                    * np.cos(back_rotation[0]),
                    (
                ...
                self.mesh = Cuboid(
                    self.main_vertical_piece_size[1] / 2
                    - sub_horizontal_piece_size[0] / 2
                    - sub_horizontal_offset[0],
                    self.sub_vertical_piece_size[0],
                    self.sub_vertical_piece_size[1],
                    position=sub_vertical_position,
                    rotation=mesh_rotation,
                )
...
class Slat_back(ConceptTemplate):
    def __init__(
        ...
        for i in range(2 + round(number_of_subs[0])):
            if i < 2:
                flag = 1 if i == 1 else -1
                vertical_rotation = [
                    back_rotation[0],
                    flag * main_vertical_rotation[0],
                    0,
                ]
                vertical_position = [
                    flag * main_vertical_separation[0] / 2,
                ...
                sub_horizontal_position = [
                    ...
                    (
                        main_vertical_piece_size[1] / 2
                        + sub_horizontal_offset[0]
                        - (i - 2) * interval_between_subs[0]
                    )
                    * np.cos(back_rotation[0])
                    - main_vertical_piece_size[0]
                    / 2
                    * np.sin(main_vertical_rotation[0])
                    * np.sin(back_rotation[0]),
                ...
                self.mesh = Cuboid(
                    self.sub_horizontal_piece_size[0],
                    self.main_vertical_separation[0]
                    - main_vertical_piece_size[0] * np.cos(main_vertical_rotation[0]),
                    self.sub_horizontal_piece_size[1],
                    position=sub_horizontal_position,
                    rotation=sub_horizontal_rotation,
                )
        ...
        for i in range(5):
            ...
            if i < 2:
                mesh_rotation = [
                    ...
                    0,
                    rotation_sign * vertical_leg_rotation[1],
                ]
                mesh_position = [
                    position_sign * vertical_leg_separation[0] / 2,
                    -vertical_leg_size[1]
                    / 2
                    * np.cos(vertical_leg_rotation[0])
                    * np.cos(vertical_leg_rotation[1]),
                    0,
                ]
                self.mesh = Cuboid(
                    self.vertical_leg_size[1],
                    self.vertical_leg_size[0],
                    self.vertical_leg_size[2],
                    position=mesh_position,
                    rotation=mesh_rotation,
                    rotation_order="ZXY",
                )
                ...
                mesh_rotation = [
                    ...
                    rotation_sign * horizontal_leg_rotation[1],
                    0,
                ]
                mesh_position = [
                    position_sign
                    * (
                        vertical_leg_separation[0] / 2
                        + vertical_leg_size[1] / 2 * np.sin(vertical_leg_rotation[1])
                        - horizontal_z_leg_size[1]
                        / 2
                        * np.sin(horizontal_leg_rotation[1])
                    ),
                    -(vertical_leg_size[1] - horizontal_z_leg_size[0] / 2)
                    * np.cos(vertical_leg_rotation[0])
                    * np.cos(vertical_leg_rotation[1])
                    + (horizontal_z_leg_size[1] + horizontal_z_leg_size[0])
                    / 2
                    * np.sin(horizontal_leg_rotation[0]),
                    -vertical_leg_size[1]
                    / 2
                    * np.cos(vertical_leg_rotation[1])
                    * np.sin(vertical_leg_rotation[0])
                    - (vertical_leg_size[2] + horizontal_z_leg_size[1])
                    / 2
                    * np.cos(horizontal_leg_rotation[1])
                    * np.cos(horizontal_leg_rotation[0]),
                ]
                self.mesh = Cuboid(
                    self.horizontal_z_leg_size[0],
                    self.vertical_leg_size[0],
                ...
                mesh_position = [
                    ...
                    * np.cos(vertical_leg_rotation[1])
                    + (
                        horizontal_z_leg_size[1] * 2
                        + horizontal_z_leg_size[0]
                        + horizontal_x_leg_size[0]
                    )
                    / 2
                    * np.sin(horizontal_leg_rotation[0]),
                    -vertical_leg_size[1]
                ...
                self.mesh = Cuboid(
                    self.horizontal_z_leg_size[0],
                    vertical_leg_separation[0]
                    + vertical_leg_size[0]
                    + vertical_leg_size[1] * np.sin(vertical_leg_rotation[1])
                    - 2
                    * (
                        horizontal_z_leg_size[1]
                        + vertical_leg_size[2] / 2
                        + horizontal_x_leg_size[0] / 2
                    )
                    * np.sin(horizontal_leg_rotation[1]),
    ...
    def __init__(
        ...
        for i in range(1 + round(number_of_sub_legs[0])):
            if i == 0:
                ...
                sub_rotation = np.pi / round(number_of_sub_legs[0]) * (i - 1) * 2
                mesh_position = [
                    -(sub_sizes[2] / 2 * np.cos(tilt_angle[0]) * np.sin(sub_rotation))
                    * np.cos(central_rotation[0])
                    + (sub_sizes[2] / 2 * np.cos(tilt_angle[0]) * np.cos(sub_rotation))
                    * np.sin(central_rotation[0]),
                    (-vertical_sizes[1] / 2 + sub_sizes[1] / 2 + sub_central_offset[0])
                    ...
                    * np.cos(horizontal_rotation[0])
                    + (-vertical_sizes[1] + sub_sizes[1] / 2 + sub_central_offset[0])
                    * np.sin(horizontal_rotation[0])
                    + vertical_sizes[1] / 2 * np.sin(horizontal_rotation[0]),
                ]
                ...
                cen_mat4 = np.array(
                    get_rodrigues_matrix([0, 1, 0], central_rotation[0])
                )
                self.mesh.vertices = np.matmul(self.mesh.vertices, cen_mat4.T)

                h_mat4 = np.array(
                    get_rodrigues_matrix([1, 0, 0], horizontal_rotation[0])
                )
                self.mesh.vertices = np.matmul(self.mesh.vertices, h_mat4.T)

                self.mesh.vertices = apply_transformation(
                    self.mesh.vertices, mesh_position, [0, 0, 0]
                )
...
class Barstool_leg(ConceptTemplate):
    def __init__(
        ...
        mesh_position = [
            0,
            (-vertical_sizes[1] - bottom_sizes[1] / 2) * np.cos(horizontal_rotation[0]),
...
class Solid_armrest(ConceptTemplate):
    def __init__(
        ...
        for i in range(2):
            ...
            mesh_position = [
                -flag * armrest_separation[0] / 2,
                size[1] / 2 * np.cos(armrest_rotation[1]) * np.cos(armrest_rotation[0])
                - size[2] / 2 * np.sin(armrest_rotation[0]),
                0,
            ]
            self.mesh = Cuboid(
                size[1],
...
class Office_armrest(ConceptTemplate):
    def __init__(
        ...
        horizontal_support_rotation = [
            x / 180 * np.pi for x in horizontal_support_rotation
        ]
        armrest_rotation = [x / 180 * np.pi for x in armrest_rotation]
        super().__init__(position, rotation)
        ...
        for i in range(4):
            ...
            if i < 2:
                mesh_rotation = [
                    horizontal_support_rotation[0],
                    0,
                    flag * armrest_rotation[0],
                ]
                mesh_position = [
                    -flag
                    * (
                        armrest_separation[0] / 2
                        + (
                            vertical_support_sizes[1]
                            * np.cos(vertical_support_rotation[0])
                            + horizontal_support_sizes[1]
                        )
                        / 2
                        * np.sin(armrest_rotation[0])
                    ),
                    (
                        vertical_support_sizes[1]
                        * np.cos(vertical_support_rotation[0])
                    ...
                    / 2
                    * np.cos(armrest_rotation[0])
                    + (
                        supports_contact_offset[0]
                        - vertical_support_sizes[1]
                        / 2
                        * np.sin(vertical_support_rotation[0])
                    )
                    * np.tan(horizontal_support_rotation[0]),
                    0,
                ]
                self.mesh = Cuboid(
                    horizontal_support_sizes[1],
                    horizontal_support_sizes[0],

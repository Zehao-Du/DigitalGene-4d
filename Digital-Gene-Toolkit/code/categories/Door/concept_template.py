    ...
    def __init__(
        ...
        if existence_of_door[0] and existence_of_door[1]:
            ...
            self.left_mesh = Cuboid(
                size[1], size[0], size[2], position=left_mesh_position
            )
            ...
            self.right_mesh = Cuboid(
                size[1], size[0], size[2], position=[-size[0] / 2, 0, 0]
            )
    ...
    def __init__(
        ...
        if existence_of_doorframe[0]:
            ...
            front_left_mesh_position = [
                ...
                - door_size[1] / 2
                + sub1_outer_size[1] / 2
                + sub1_inner_outer_offset[1],
                -sub1_outer_size[2] / 2 + main_offset[1] + main_outer_size[2] / 2,
            ]
            self.front_left_mesh = Cuboid(
                front_left_size[1],
                front_left_size[0],
                front_left_size[2],
        ...
        if existence_of_doorframe[1]:
            ...
            back_left_mesh_position = [
                ...
                - door_size[1] / 2
                + sub2_outer_size[1] / 2
                + sub2_inner_outer_offset[1],
                -sub2_outer_size[2] / 2 + main_offset[1] - main_outer_size[2] / 2,
            ]
            self.back_left_mesh = Cuboid(
                back_left_size[1],
                back_left_size[0],
                back_left_size[2],
...
class Standard_Hinge(ConceptTemplate):
    def __init__(
        ...
        # Record Parameters
        self.existence_of_door = existence_of_door
        self.number_of_hinge = [round(item) for item in number_of_hinge]
        self.size = size
        ...
        offset = offset_1
        for existence in range(round(existence_of_door[0] + existence_of_door[1])):
            for i in range(round(number_of_hinge[0])):
                tmp_mesh_position = [
                    offset[0],
                ...
                self.tmp_mesh = Cylinder(
                    size[1], size[0], size[0], position=tmp_mesh_position
                )
    ...
    def __init__(
        ...
        for direction_setting in self.direction_settings:
            ...
            base_mesh_position = [
                ...
                * (door_size[2] / 2 + fixed_part_size[2] / 2),
            ]
            ...
            middle_mesh_position = [
                ...
                direction_setting["handle_z_direction"]
                * (
                    door_size[2] / 2 + fixed_part_size[2] + vertical_movable_size[2] / 2
                ),
            ]
            self.middle_mesh = Cuboid(
                vertical_movable_size[1],
                vertical_movable_size[0],
            ...
            self.top_mesh = Cuboid(
                horizontal_movable_size[1],
                horizontal_movable_size[0],
                horizontal_movable_size[2],
            ...
            for tmp_mesh in tmp_meshes:
                tmp_mesh.vertices = apply_transformation(
                    tmp_mesh.vertices,
                    [-direction_setting["handle_y_axis"], 0, 0],
                    [0, 0, 0],
                )
                tmp_mesh.vertices = apply_transformation(
                    tmp_mesh.vertices,
                    [direction_setting["handle_y_axis"], 0, 0],
                    [0, direction_setting["handle_y_rotation"], 0],
                )
    ...
    def __init__(
        ...
        for direction_setting in self.direction_settings:
            ...
            top_mesh_position = [
                ...
                direction_setting["handle_z_direction"]
                * (door_size[2] / 2 + sub_size[2] / 2),
            ]
            self.top_mesh = Cuboid(
                sub_size[1], sub_size[0], sub_size[2], position=top_mesh_position
            )
            tmp_meshes.append(self.top_mesh)
            ...
            self.bottom_mesh = Cuboid(
                sub_size[1], sub_size[0], sub_size[2], position=bottom_mesh_position
            )
            ...
            self.main_mesh = Cuboid(
                main_size[1], main_size[0], main_size[2], position=main_mesh_position
            )
    ...
    def __init__(
        ...
        for direction_setting in self.direction_settings:
            ...
            base_mesh_position = [
                ...
                0,
                direction_setting["handle_z_direction"]
                * (door_size[2] / 2 + fixed_part_size[1] / 2),
            ]
            ...
            middle_mesh_position = [
                ...
                0,
                direction_setting["handle_z_direction"]
                * (door_size[2] / 2 + fixed_part_size[1] + sub_size[1] / 2),
            ]
            middle_mesh_rotation = [np.pi / 2, 0, 0]
            self.middle_mesh = Cylinder(
                sub_size[1],
                sub_size[0],
                sub_size[0],
                position=middle_mesh_position,
...
class Spherical_Handle(ConceptTemplate):
    def __init__(
        ...
        for direction_setting in self.direction_settings:
            ...
            self.main_mesh = Sphere(
                main_size[0],
                radius_y=main_size[1],
                radius_z=main_size[2],
                position=main_mesh_position,
            )
            tmp_meshes.append(self.main_mesh)

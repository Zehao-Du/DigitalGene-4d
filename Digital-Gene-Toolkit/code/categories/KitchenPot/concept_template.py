...
class Carved_Cylindrical_Cover(ConceptTemplate):
    def __init__(self, outer_size, inner_size, position=[0, 0, 0], rotation=[0, 0, 0]):
        ...
        self.top_mesh = Cylinder(
            top_height, outer_size[0], middle_radius, position=top_mesh_position
        )
        vertices_list.append(self.top_mesh.vertices)
        faces_list.append(self.top_mesh.faces + total_num_vertices)
        total_num_vertices += len(self.top_mesh.vertices)
...
class Semi_Spherical_Cover(ConceptTemplate):
    def __init__(self, radius, exist_angle, position=[0, 0, 0], rotation=[0, 0, 0]):
        ...
        mesh_position = [0, -radius[0] * np.cos(exist_angle[0]), 0]
        self.mesh = Sphere(radius[0], 0, exist_angle[0], position=mesh_position)
        vertices_list.append(self.mesh.vertices)
        faces_list.append(self.mesh.faces + total_num_vertices)
        total_num_vertices += len(self.mesh.vertices)
...
class Trifold_Tophandle(ConceptTemplate):
    def __init__(
        ...
        left_mesh_position = [
            ...
            + mounting_size[1] * np.sin(mounting_rotation[0]) / 2,
        ...
        self.top_mesh = Cuboid(
            grip_size[1], grip_size[0], grip_size[2], position=top_mesh_position
        )
        vertices_list.append(self.top_mesh.vertices)
        faces_list.append(self.top_mesh.faces + total_num_vertices)
        total_num_vertices += len(self.top_mesh.vertices)
...
class Semi_Ring_Tophandle(ConceptTemplate):
    def __init__(
        ...
        mesh_position = [0, -curve_size[0] * np.cos(curve_exist_angle[0] / 2), 0]
        mesh_rotation = [-np.pi / 2, -np.pi / 2 + curve_exist_angle[0] / 2, 0]
        self.mesh = Ring(
            curve_size[2],
            curve_size[0],
            curve_size[1],
...
class Multilevel_Tophandle(ConceptTemplate):
    def __init__(
        ...
        # Record Parameters
        self.num_levels = [round(item) for item in num_levels]
...
class Trifold_Sidehandle(ConceptTemplate):
    def __init__(
        ...
        left_1_mesh_position = [
            ...
            0,
            mounting_seperation[0] / 2
            + mounting_size[0] * np.sin(mounting_rotation[0]) / 2,
        ]
        left_1_mesh_rotation = [0, -mounting_rotation[0], 0]

        left_1_mesh_position = adjust_position_from_rotation(
            left_1_mesh_position, level_1_rotation
        )
        ...
        right_1_mesh_position = adjust_position_from_rotation(
            right_1_mesh_position, level_1_rotation
        )
        ...
        top_1_mesh_position = adjust_position_from_rotation(
            top_1_mesh_position, level_1_rotation
        )
        ...
        left_2_mesh_position = adjust_position_from_rotation(
            left_2_mesh_position, level_2_rotation
        )
        ...
        right_2_mesh_position = adjust_position_from_rotation(
            right_2_mesh_position, level_2_rotation
        )
        ...
        top_2_mesh_position = adjust_position_from_rotation(
            top_2_mesh_position, level_2_rotation
        )
...
class L_Shaped_Sidehandle(ConceptTemplate):
    def __init__(
        ...
        # level_1
        bottom_1_mesh_position = [handle_seperation[0] / 2 + bottom_size[0] / 2, 0, 0]
        self.bottom_1_mesh = Cuboid(
            bottom_size[1],
            bottom_size[0],
            bottom_size[2],
        ...
        self.top_1_mesh = Cuboid(
            top_size[1], top_size[0], top_size[2], position=top_1_mesh_position
        )
        vertices_list.append(self.top_1_mesh.vertices)
        faces_list.append(self.top_1_mesh.faces + total_num_vertices)
        total_num_vertices += len(self.top_1_mesh.vertices)
        ...
        # level_2
        bottom_2_mesh_position = [-handle_seperation[0] / 2 - bottom_size[0] / 2, 0, 0]
        self.bottom_2_mesh = Cuboid(
            bottom_size[1],
            bottom_size[0],
            bottom_size[2],
        ...
        self.top_2_mesh = Cuboid(
            top_size[1], top_size[0], top_size[2], position=top_2_mesh_position
        )
        vertices_list.append(self.top_2_mesh.vertices)
        faces_list.append(self.top_2_mesh.faces + total_num_vertices)
        total_num_vertices += len(self.top_2_mesh.vertices)

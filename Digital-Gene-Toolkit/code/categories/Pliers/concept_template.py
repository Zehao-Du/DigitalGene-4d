...
from code.utils import adjust_position_from_rotation, apply_transformation, list_add
...
class Round_Shaft(ConceptTemplate):
    def __init__(
        ...
        if has_central_shaft[0] == 1:
            ...
            self.mesh = Cylinder(
                central_shaft_size[1], central_shaft_size[0], position=mesh_position
            )
            vertices_list.append(self.mesh.vertices)
            faces_list.append(self.mesh.faces + total_num_vertices)
            total_num_vertices += len(self.mesh.vertices)
...
class Rectangular_Shaft(ConceptTemplate):
    def __init__(
        ...
        layer_1_mesh_position = [0, -layer_1_size[1] / 2, 0]
        layer_1_mesh_rotation = [0, layer_rotation[0], 0]
        self.layer_1_mesh = Cuboid(
            layer_1_size[1],
            layer_1_size[0],
            layer_1_size[2],
...
class Straight_Handle(ConceptTemplate):
    def __init__(
        ...
        # front_left
        front_1_mesh_position_1 = [0, 0, -front_size[2] / 2]
        front_1_mesh_rotation = [0, -handle_rotation[0], 0]
        front_1_mesh_position_1 = adjust_position_from_rotation(
            front_1_mesh_position_1, front_1_mesh_rotation
        )

        front_1_mesh_position_2 = [handle_separation[0] / 2, 0, 0]
        front_1_mesh_position = list_add(
            front_1_mesh_position_1, front_1_mesh_position_2
        )

        self.front_1_mesh = Cuboid(
            front_size[1],
            front_size[0],
            front_size[2],
        ...
        # front_right
        front_2_mesh_position_1 = [0, 0, -front_size[2] / 2]
        front_2_mesh_rotation = [0, handle_rotation[0], 0]
        front_2_mesh_position_1 = adjust_position_from_rotation(
            front_2_mesh_position_1, front_2_mesh_rotation
        )

        front_2_mesh_position_2 = [-handle_separation[0] / 2, left_right_offset[0], 0]
        front_2_mesh_position = list_add(
            front_2_mesh_position_1, front_2_mesh_position_2
        )

        self.front_2_mesh = Cuboid(
            front_size[1],
            front_size[0],
            front_size[2],
...
class Middle_Curved_Handle(ConceptTemplate):
    def __init__(
        ...
        middle_offset_x = curve_offset_x * np.cos(
            handle_rotation[1]
        ) - curve_offset_z * np.sin(handle_rotation[1])
        middle_offset_z = curve_offset_x * np.sin(
            handle_rotation[1]
        ) + curve_offset_z * np.cos(handle_rotation[1])
        behind_1_mesh_position_2 = [
            handle_separation[0] / 2
            - front_size[0] / 2 * np.cos(handle_rotation[0])
            + front_size[2] * np.sin(handle_rotation[0])
...
class Asymmetric_Straight_Handle(ConceptTemplate):
    def __init__(
        ...
        left_front_size,
        left_behind_size,
        left_handle_rotation,
        left_front_behind_offset,
        right_front_size,
        right_behind_size,
        right_handle_rotation,
        right_front_behind_offset,
        handle_separation,
        left_right_offset,
        position=[0, 0, 0],
        rotation=[0, 0, 0],
        ...
        # front_left
        front_1_mesh_position_1 = [0, 0, -left_front_size[2] / 2]
        ...
        # front_right
        front_2_mesh_position_1 = [0, 0, -right_front_size[2] / 2]
...
class Cusp_Gripper(ConceptTemplate):
    def __init__(
        ...
        front_1_mesh_position_1 = adjust_position_from_rotation(
            front_1_mesh_position_1, front_1_mesh_rotation_2
        )

        front_1_mesh_position_2 = [gripper_separation[0] / 2, 0, 0]
        front_1_mesh_position = list_add(
            front_1_mesh_position_1, front_1_mesh_position_2
        )
        front_1_mesh_rotation = list_add(
            front_1_mesh_rotation_1, front_1_mesh_rotation_2
        )
        ...
        behind_1_mesh_position_1 = [behind_size[0] / 2, 0, behind_size[3] / 2]
        behind_1_mesh_rotation_2 = [0, gripper_rotation[0], 0]
        behind_1_mesh_position_1 = adjust_position_from_rotation(
            behind_1_mesh_position_1, behind_1_mesh_rotation_2
        )

        behind_1_mesh_position_2 = [gripper_separation[0] / 2, 0, 0]
        behind_1_mesh_position = list_add(
            behind_1_mesh_position_1, behind_1_mesh_position_2
        )
        behind_1_mesh_rotation = list_add(
            behind_1_mesh_rotation_1, behind_1_mesh_rotation_2
        )
        ...
        front_2_mesh_position_1 = adjust_position_from_rotation(
            front_2_mesh_position_1, front_2_mesh_rotation_2
        )

        front_2_mesh_position_2 = [-gripper_separation[0] / 2, 0, 0]
        front_2_mesh_position = list_add(
            front_2_mesh_position_1, front_2_mesh_position_2
        )
        front_2_mesh_rotation = list_add(
            front_2_mesh_rotation_1, front_2_mesh_rotation_2
        )
        ...
        behind_2_mesh_position_1 = [-behind_size[0] / 2, 0, behind_size[3] / 2]
        behind_2_mesh_rotation_2 = [0, -gripper_rotation[0], 0]
        behind_2_mesh_position_1 = adjust_position_from_rotation(
            behind_2_mesh_position_1, behind_2_mesh_rotation_2
        )

        behind_2_mesh_position_2 = [-gripper_separation[0] / 2, 0, 0]
        behind_2_mesh_position = list_add(
            behind_2_mesh_position_1, behind_2_mesh_position_2
        )
        behind_2_mesh_rotation = list_add(
...
class Curved_Gripper(ConceptTemplate):
    def __init__(
        ...
        left_mesh_position = [gripper_separation[0] / 2, 0, 0]
        ...
        self.left_mesh = Cylinder(
            ...
            radius[0],
            radius[0],
            top_radius_z=radius[1],
            bottom_radius_z=radius[1],
            is_quarter=True,
        ...
        right_mesh_position = [-gripper_separation[0] / 2, 0, 0]
...
class Rectangular_Baffle(ConceptTemplate):
    def __init__(
        ...
        left_mesh_position = [baffle_separation[0] / 2, 0, 0]
        ...
        right_mesh_position = [-baffle_separation[0] / 2, 0, 0]
...
class Curved_Baffle(ConceptTemplate):
    def __init__(
        ...
        left_mesh_rotation = [0, np.pi / 2 - seperation_rotation[0] / 2, 0]

        self.left_mesh = Ring(
            height[0], radius[0], radius[1], exist_angle[0], rotation=left_mesh_rotation
        )
        vertices_list.append(self.left_mesh.vertices)
        faces_list.append(self.left_mesh.faces + total_num_vertices)
        total_num_vertices += len(self.left_mesh.vertices)

        right_mesh_rotation = [0, np.pi / 2 - seperation_rotation[0] / 2, np.pi]

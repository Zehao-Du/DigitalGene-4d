...
class Asymmetrical_body(ConceptTemplate):
    def __init__(
        ...
        mesh_1_position = [
            -separation[0]
            - left_size[0] / 2 * np.cos(body_rotation[0])
            - left_size[1] / 2 * np.sin(body_rotation[0]),
            -left_size[0] / 2 * np.sin(body_rotation[0])
            + left_size[1] / 2 * np.cos(body_rotation[0]),
            -left_right_offset[0],
        ]
        self.mesh_1 = Cuboid(
            left_size[1],
        ...
        mesh_2_position = [
            separation[0]
            + right_size[0] / 2 * np.cos(body_rotation[0])
            - right_size[1] / 2 * np.sin(-body_rotation[0]),
            right_size[0] / 2 * np.sin(-body_rotation[0])
            + right_size[1] / 2 * np.cos(body_rotation[0]),
            left_right_offset[0],
        ]
        self.mesh_2 = Cuboid(
            right_size[1],

...
class Standard_Body(ConceptTemplate):
    def __init__(
        ...
        if has_shaft[0] == 1:
            ...
            self.central_shaft_mesh = Cylinder(
                shaft_central_size[1],
                shaft_central_size[0],
            ...
            self.right_shaft_mesh = Cylinder(
                shaft_beside_size[1],
                shaft_beside_size[0],
...
class Carved_Cover(ConceptTemplate):
    def __init__(self, outer_size, inner_size, position=[0, 0, 0], rotation=[0, 0, 0]):
        ...
        self.bottom_mesh = Rectangular_Ring(
            inner_size[1],
            outer_size[0],
            outer_size[2],
            inner_size[0],
...
class Complex_Magazine(ConceptTemplate):
    def __init__(
        ...
        bottom_mesh_position = [0, thickness[0] / 2, size[2] / 2]
        ...
        front_mesh_position = [0, front_height[0] / 2, size[2] - thickness[0] / 2]
        self.front_mesh = Cuboid(
            front_height[0], size[0], thickness[0], position=front_mesh_position
        )
        ...
        self.left_mesh = Cuboid(
            size[1], thickness[0], beside_length[0], position=left_mesh_position
        )
        vertices_list.append(self.left_mesh.vertices)
        faces_list.append(self.left_mesh.faces + total_num_vertices)
        total_num_vertices += len(self.left_mesh.vertices)
        ...
        self.right_mesh = Cuboid(
            size[1], thickness[0], beside_length[0], position=right_mesh_position
        )
        vertices_list.append(self.right_mesh.vertices)
        faces_list.append(self.right_mesh.faces + total_num_vertices)
        total_num_vertices += len(self.right_mesh.vertices)

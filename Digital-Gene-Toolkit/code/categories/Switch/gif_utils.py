...
def assemble_concepts_instance(concepts):
    ...
    for c in concepts:
        ...
        try:
            ...
            if "switch" in module_name.lower():
                number_of_switch = component.number_of_switch
                num_instance = number_of_switch[0]
            elif module_name in ["Cylindrical_Plug", "Cuboidal_Plug"]:
                column_of_contact = component.column_of_contact
                row_of_contact = component.row_of_contact
                num_instance = column_of_contact[0] * row_of_contact[0]
            elif module_name == "Parallel_Base":
                num_instance = 2
            else:
                num_instance = 1

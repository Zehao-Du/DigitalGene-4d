from code.base_template import ConceptTemplate
from code.geometry_template import *
from code.knowledge_utils import *
...
class L_type_desktop(ConceptTemplate):
    def __init__(
        ...
        self.base_mesh = Cuboid(
            self.horizontal_size[1], self.horizontal_size[0], self.horizontal_size[2]
        )
        ...
        other_mesh_position = [
            -horizontal_size[0] / 2
            - np.sqrt(vertical_size[0] ** 2) * np.sin(desktop_angle[0]),
            0,
            -horizontal_size[1] / 2
            - np.sqrt(vertical_size[0] ** 2) * np.cos(desktop_angle[0]),
        ]
        self.other_mesh = Cuboid(
            self.horizontal_size[1],
            self.horizontal_size[0],
            self.horizontal_size[2],
            position=other_mesh_position,
            rotation=other_mesh_rotation,
        )
...
class Regular_leg(ConceptTemplate):
    def __init__(
        ...
        additional_legs_params = [
            ...
            for i, x in enumerate(additional_legs_params)
        ]
        super().__init__(position, rotation)
        ...
        self.number_of_legs = [round(item) for item in number_of_legs]
        ...
        self.number_of_additional_legs = round(additional_legs_params[0])
        ...
        for i in range(round(number_of_legs[0])):
            if round(number_of_legs[0]) == 1:
                mesh_rotation = [front_rotation[0], central_rotation[0], 0]
                mesh_position = [
                    0,
                    -front_legs_size[1] * np.cos(front_rotation[0]) / 2,
                    0,
                ]
                self.mesh = Cuboid(
                    self.front_legs_size[1],
                    self.front_legs_size[0],
                    self.front_legs_size[2],
                    position=mesh_position,
                    rotation=mesh_rotation,
                )

            if round(number_of_legs[0]) == 2:
                rotation_sign = 1 if (i == 0 or self.symmetry_mode == 0) else -1
                position_sign = 1 if i == 1 else -1
                mesh_rotation = [
                    front_rotation[0],
                    central_rotation[0],
                    rotation_sign * front_rotation[1],
                ]
                mesh_position = [
                    position_sign
                    * legs_separation[0]
                    / 2
                    * np.cos(central_rotation[0]),
                    -front_legs_size[1] / 2 * np.cos(front_rotation[0]),
                    position_sign
                    * legs_separation[0]
                    / 2
                    * np.sin(central_rotation[0]),
                ]
                self.mesh = Cuboid(
                    self.front_legs_size[1],
                    self.front_legs_size[0],
                ...
                if i < 2:
                    ...
                    mesh_position = [
                        ...
                        * legs_separation[0]
                        / 2
                        * np.cos(central_rotation[0])
                        + legs_separation[2] / 2 * np.sin(central_rotation[0]),
                        -front_legs_size[1]
                        / 2
                        * np.cos(front_rotation[0])
                        * np.cos(front_rotation[1]),
                        -position_sign
                        * legs_separation[0]
                        / 2
                        * np.sin(central_rotation[0])
                    ...
                    mesh_position = [
                        ...
                        -rear_legs_size[1]
                        / 2
                        * np.cos(rear_rotation[0])
                        * np.cos(rear_rotation[1]),
                        -legs_separation[2] / 2 * np.cos(central_rotation[0]),
                    ]
                    size = rear_legs_size
                self.mesh = Cuboid(
        ...
        for i in range(self.number_of_additional_legs):
            mesh_position = [
                self.additional_legs_attributes[9 * i + 3] - position[0],
                self.additional_legs_attributes[9 * i + 4]
                - self.additional_legs_attributes[9 * i + 1]
                * np.cos(self.additional_legs_attributes[9 * i + 6])
                * np.cos(self.additional_legs_attributes[9 * i + 8])
                / 2,
                self.additional_legs_attributes[9 * i + 5] - position[2],
            ]
            mesh_rotation = [
                self.additional_legs_attributes[9 * i + 6],
                self.additional_legs_attributes[9 * i + 7],
                self.additional_legs_attributes[9 * i + 8],
            ]
            self.additional_mesh = Cuboid(
                self.additional_legs_attributes[9 * i + 1],
    ...
    def __init__(
        ...
        for i in range(4):
            ...
            if i < 2:
                ...
                mesh_position = [
                    position_sign * legs_separation[0] / 2 * np.cos(central_rotation[0])
                    + legs_separation[2] / 2 * np.sin(central_rotation[0]),
                    -front_legs_size[1]
                    / 2
                    * np.cos(front_rotation[0])
                ...
                mesh_position = [
                    position_sign * legs_separation[1] / 2 * np.cos(central_rotation[0])
                    - legs_separation[2] / 2 * np.sin(central_rotation[0]),
                    -front_legs_size[1]
                    / 2
                    * np.cos(front_rotation[0])
                ...
                self.mesh = Cuboid(
                    self.rear_legs_size[1],
                    self.rear_legs_size[0],
                    self.rear_legs_size[2],
                    position=mesh_position,
                    rotation=mesh_rotation,
                )
        ...
        if bridging_bars_existance[0] == 1:
            ...
            mesh_position = [
                (
                    legs_separation[2] / 2
                    + front_rear_bridging_bars_offset[0] * np.sin(front_rotation[0])
                )
                * np.sin(central_rotation[0]),
                -(front_legs_size[1] / 2 - front_rear_bridging_bars_offset[0])
                * np.cos(front_rotation[0])
                * np.cos(front_rotation[1]),
                (
                    legs_separation[2] / 2
            ...
            self.mesh = Cuboid(
                front_rear_bridging_bars_sizes[0],
                legs_separation[0]
                - front_legs_size[0]
                + front_rear_bridging_bars_offset[0] * np.sin(front_rotation[1]) * 2,
        ...
        if bridging_bars_existance[1] == 1:
            ...
            mesh_position = [
                (
                    -legs_separation[2] / 2
                    + front_rear_bridging_bars_offset[1] * np.sin(rear_rotation[0])
                )
                * np.sin(central_rotation[0]),
                -(rear_legs_size[1] / 2 - front_rear_bridging_bars_offset[1])
                * np.cos(rear_rotation[0])
                * np.cos(rear_rotation[1]),
                (
                    -legs_separation[2] / 2
            ...
            self.mesh = Cuboid(
                ...
                legs_separation[1]
                - rear_legs_size[0]
                + front_rear_bridging_bars_offset[1] * np.sin(front_rotation[1]) * 2,
                front_rear_bridging_bars_sizes[1],
                position=mesh_position,
                rotation=mesh_rotation,
            )
        ...
        if bridging_bars_existance[2] == 1:
            fr_an_x = -legs_separation[0] / 2 - left_right_bridging_bars_offset[
                0
            ] * np.cos(front_rotation[0]) * np.sin(front_rotation[1])
            fr_an_y = (
                -(front_legs_size[1] / 2 - left_right_bridging_bars_offset[0])
                * np.cos(front_rotation[0])
                * np.cos(front_rotation[1])
            )
            fr_an_z = legs_separation[2] / 2 + left_right_bridging_bars_offset[
                0
            ] * np.sin(front_rotation[0])

            re_an_x = -legs_separation[1] / 2 - left_right_bridging_bars_offset[
                1
            ] * np.cos(rear_rotation[0]) * np.sin(rear_rotation[1])
            re_an_y = (
                -(rear_legs_size[1] / 2 - left_right_bridging_bars_offset[1])
                * np.cos(rear_rotation[0])
                * np.cos(rear_rotation[1])
            )
            re_an_z = -legs_separation[2] / 2 + left_right_bridging_bars_offset[
                1
            ] * np.sin(rear_rotation[0])
            ...
            if diff_norm > 0:
                mesh_rotation = [
                    -np.arcsin(diff_y / diff_norm),
                    np.arctan(diff_x / np.sign(diff_z) / (np.abs(diff_z) + 1e-7))
                    + central_rotation[0],
                    0,
                ]
                mesh_position = [
                    (fr_an_x + re_an_x) / 2 * np.cos(central_rotation[0])
                    + (fr_an_z + re_an_z) / 2 * np.sin(central_rotation[0]),
                    (fr_an_y + re_an_y) / 2,
                    (fr_an_z + re_an_z) / 2 * np.cos(central_rotation[0])
                    - (fr_an_x + re_an_x) / 2 * np.sin(central_rotation[0]),
                ]
        ...
        if bridging_bars_existance[3] == 1:
            ...
            re_an_y = (
                -(front_legs_size[1] / 2 - left_right_bridging_bars_offset[1])
                * np.cos(rear_rotation[0])
                * np.cos(rear_rotation[1])
            )
            re_an_z = -legs_separation[2] / 2 + left_right_bridging_bars_offset[
    ...
    def __init__(
        ...
        if self.number_of_legs[0] == 4:
            ...
            for i in range(round(number_of_legs[0])):
                ...
                if i < 2:
                    mesh_rotation = [
                        other_rotation[0],
                        central_rotation[0],
                        rotation_sign * other_rotation[1],
                    ]
                    mesh_position = [
                        position_sign
                        * legs_separation[0]
                        ...
                        * np.cos(central_rotation[0])
                        ...
                        -front_legs_size[1]
                        / 2
                        * np.cos(other_rotation[0])
                        * np.cos(other_rotation[1]),
                        -position_sign
                        * legs_separation[0]
                        / 2
                        * np.sin(central_rotation[0])
            ...
            for i in range(2):
                ...
                length = np.sqrt(
                    (front_position[0] - rear_position[0]) ** 2
                    + (front_position[1] - rear_position[1]) ** 2
                    + (front_position[2] - rear_position[2]) ** 2
                )
                direction_vector = np.array(
                    [
                        front_position[0] - rear_position[0],
                        front_position[2] - rear_position[2],
                    ]
                )
...
class Star_leg(ConceptTemplate):
    def __init__(
        ...
        self.number_of_sub_legs = [round(item) for item in number_of_sub_legs]
        self.number_of_additional_legs = round(additional_legs_params[0])
        self.additional_legs_attributes = additional_legs_params[1:]
        ...
        for i in range(1 + round(number_of_sub_legs[0])):
            if i == 0:
                mesh_rotation = [horizontal_rotation[0], central_rotation[0], 0]
                mesh_position = [
                    0,
                    -vertical_size[1] / 2 * np.cos(horizontal_rotation[0]),
                    0,
                ]
                self.mesh = Cylinder(
                    vertical_size[1],
                ...
                mesh_rotation = [
                    tilt_angle[0] + horizontal_rotation[0],
                    central_rotation[0] - sub_rotation,
                    0,
                ]
                mesh_position = [
                    -(sub_size[2] / 2 * np.cos(tilt_angle[0]) * np.sin(sub_rotation))
                    * np.cos(central_rotation[0])
                    + (sub_size[2] / 2 * np.cos(tilt_angle[0]) * np.cos(sub_rotation))
                    * np.sin(central_rotation[0]),
                    (-vertical_size[1] + sub_size[1] / 2 + sub_central_offset[0])
                    ...
                    * np.cos(horizontal_rotation[0])
                    + (-vertical_size[1] + sub_size[1] / 2 + sub_central_offset[0])
                    * np.sin(horizontal_rotation[0])
                    + vertical_size[1] / 2 * np.sin(horizontal_rotation[0]),
                ]
                self.mesh = Cuboid(
                    sub_size[1],
                    sub_size[0],
...
class Bar_cylindrical_leg(ConceptTemplate):
    def __init__(
        ...
        mesh_position = [
            0,
            (-vertical_size[1] - bottom_size[1] / 2) * np.cos(horizontal_rotation[0]),
...
class Desk_type_leg(ConceptTemplate):
    def __init__(
        ...
        self.horizontal_rotation = horizontal_rotation
        self.connections_size = connections_size
        self.number_of_connections = [round(item) for item in number_of_connections]
        self.connections_offset = connections_offset
        ...
        for i in range(4 + round(number_of_connections[0])):
            rotation_sign = 1 if i == 0 else -1
            position_sign = -1 if (i % 2 == 0) else 1
            pose = apply_transformation(
                [0, -vertical_size[1] / 2, 0],
                [0, 0, 0],
            ...
            if i < 2:
                mesh_rotation = [
                    vertical_rotation[0],
                    0,
                    rotation_sign * vertical_rotation[1],
                ]
                ...
                mesh_rotation = [horizontal_rotation[0], 0, 0]
                mesh_position = [
                    position_sign * (vertical_separation[0] / 2 - pose[0]),
                    2 * pose[1],
                ...
                mesh_position = [
                    ...
                    -(
                        vertical_size[1] / 2
                        - (
                            (i - 4) * interval_between_connections[0]
                            + connections_offset[0]
                        )
                        * np.cos(vertical_rotation[0])
                        * np.cos(vertical_rotation[1])
                    ),
                    ((i - 4) * interval_between_connections[0] + connections_offset[0])
                    * np.sin(vertical_rotation[0]),
                ]
                self.mesh = Cuboid(
                    connections_size[0],
...
class Regular_sublayer(ConceptTemplate):
    def __init__(
        ...
        self.number_of_subs = [round(item) for item in number_of_subs]
        self.subs_offset = subs_offset
        self.interval_between_subs = interval_between_subs
        self.number_of_additional_sublayers = round(additional_sublayers_params[0])
        ...
        for i in range(round(number_of_subs[0])):
            mesh_rotation = [0, 0, 0]
...
class Cylindrical_sublayer(ConceptTemplate):
    def __init__(
        ...
        for i in range(self.number_of_additional_sublayers):
            mesh_position = [
                self.additional_sublayers_attributes[9 * i + 3],
...
class Regular_backboard(ConceptTemplate):
    def __init__(self, size, position=[0, 0, 0], rotation=[0, 0, 0]):
        ...
        self.mesh = Cuboid(
            size[1], size[0], size[2], position=mesh_position, rotation=mesh_rotation
        )
        vertices_list.append(self.mesh.vertices)
        faces_list.append(self.mesh.faces + total_num_vertices)
        total_num_vertices += len(self.mesh.vertices)
...
class Regular_drawer(ConceptTemplate):
    def __init__(
        self, number_of_drawer, drawers_params, position=[0, 0, 0], rotation=[0, 0, 0]
    ):
        # Process rotation param
        rotation = [x / 180 * np.pi for x in rotation]
        drawers_params = [
            x / 180 * np.pi if i % 21 in [14] else x
            for i, x in enumerate(drawers_params)
        ]
        super().__init__(position, rotation)

        # Record Parameters
        self.number_of_drawer = [round(item) for item in number_of_drawer]
        self.drawer_size = [
            drawers_params[i * 21 : i * 21 + 3]
            for i in range(round(number_of_drawer[0]))
        ]
        self.bottom_size = [
            drawers_params[i * 21 + 3] for i in range(round(number_of_drawer[0]))
        ]
        self.front_size = [
            drawers_params[i * 21 + 4 : i * 21 + 7]
            for i in range(round(number_of_drawer[0]))
        ]
        self.front_offset = [
            drawers_params[i * 21 + 7] for i in range(round(number_of_drawer[0]))
        ]
        self.left_right_inner_size = [
            drawers_params[i * 21 + 8] for i in range(round(number_of_drawer[0]))
        ]
        self.rear_front_inner_size = [
            drawers_params[i * 21 + 9] for i in range(round(number_of_drawer[0]))
        ]
        self.number_of_handle = [
            round(drawers_params[i * 21 + 10])
            for i in range(round(number_of_drawer[0]))
        ]
        self.handle_sizes = [
            drawers_params[i * 21 + 11 : i * 21 + 14]
            for i in range(round(number_of_drawer[0]))
        ]
        self.handle_rotation = [
            drawers_params[i * 21 + 14] for i in range(round(number_of_drawer[0]))
        ]
        self.handle_offset = [
            drawers_params[i * 21 + 15 : i * 21 + 17]
            for i in range(round(number_of_drawer[0]))
        ]
        self.handle_separation = [
            drawers_params[i * 21 + 17] for i in range(round(number_of_drawer[0]))
        ]
        self.drawer_offset = [
            drawers_params[i * 21 + 18 : i * 21 + 21]
            for i in range(round(number_of_drawer[0]))
        ]
        ...
        for drawer_idx in range(round(number_of_drawer[0])):
            for mesh_idx in range(6 + self.number_of_handle[drawer_idx]):
                if mesh_idx < 2:
                    ...
                    self.mesh = Cuboid(
                        self.drawer_size[drawer_idx][1],
                        self.drawer_size[drawer_idx][0]
                        - 2 * self.left_right_inner_size[drawer_idx],
                        self.rear_front_inner_size[drawer_idx],
                        position=mesh_position,
                    )
                elif mesh_idx == 4:
                    ...
                    mesh_position = [
                        ...
                        self.drawer_offset[drawer_idx][2]
                        + self.drawer_size[drawer_idx][2] / 2
                        + self.front_size[drawer_idx][2] / 2,
                    ]
                    self.mesh = Cuboid(
                        self.front_size[drawer_idx][1],
                    ...
                    self.mesh = Cuboid(
                        self.handle_sizes[drawer_idx][1],
                        self.handle_sizes[drawer_idx][0],
                        self.handle_sizes[drawer_idx][2],
                        position=mesh_position,
                        rotation=mesh_rotation,
                    )
                vertices_list.append(self.mesh.vertices)
...
class Regular_door(ConceptTemplate):
    def __init__(
        self, number_of_door, doors_params, position=[0, 0, 0], rotation=[0, 0, 0]
    ):
        # Process rotation param
        rotation = [x / 180 * np.pi for x in rotation]
        doors_params = [
            x / 180 * np.pi if i % 13 in [6, 9] else x
            for i, x in enumerate(doors_params)
        ]
        super().__init__(position, rotation)

        # Record Parameters
        self.number_of_door = [round(item) for item in number_of_door]
        self.door_size = [
            doors_params[i * 13 : i * 13 + 3] for i in range(round(number_of_door[0]))
        ]
        self.handle_size = [
            doors_params[i * 13 + 3 : i * 13 + 6]
            for i in range(round(number_of_door[0]))
        ]
        self.handle_rotation = [
            doors_params[i * 13 + 6] for i in range(round(number_of_door[0]))
        ]
        self.handle_offset = [
            doors_params[i * 13 + 7 : i * 13 + 9]
            for i in range(round(number_of_door[0]))
        ]
        self.door_rotation = [
            doors_params[i * 13 + 9] for i in range(round(number_of_door[0]))
        ]
        self.door_offset = [
            doors_params[i * 13 + 10 : i * 13 + 13]
            for i in range(round(number_of_door[0]))
        ]
        ...
        for door_idx in range(self.number_of_door[0]):
            for mesh_idx in range(2):
                if mesh_idx == 0:
                    ...
                    mesh_position = [
                        self.door_offset[door_idx][0],
                        self.door_offset[door_idx][1] - self.door_size[door_idx][1] / 2,
                        self.door_offset[door_idx][2],
                    ]
                    self.mesh = Cuboid(
                        self.door_size[door_idx][1],
                        self.door_size[door_idx][0],
                        self.door_size[door_idx][2],
                        position=mesh_position,
                        rotation=mesh_rotation,
                    )
                else:
                    mesh_rotation = [
                        ...
                        self.handle_rotation[door_idx],
                    ]
                    mesh_position = [
                        self.door_offset[door_idx][0]
                        + self.handle_offset[door_idx][0]
                        * np.cos(self.door_rotation[door_idx])
                        + self.handle_size[door_idx][2]
                        / 2
                        * np.sin(self.door_rotation[door_idx]),
                        self.door_offset[door_idx][1]
                        - self.door_size[door_idx][1] / 2
                        + self.handle_offset[door_idx][1],
                        self.door_offset[door_idx][2]
                        - self.handle_offset[door_idx][0]
                        * np.sin(self.door_rotation[door_idx])
                        + self.handle_size[door_idx][2]
                    ...
                    self.mesh = Cuboid(
                        self.handle_size[door_idx][1],
                        self.handle_size[door_idx][0],
                        self.handle_size[door_idx][2],
                        position=mesh_position,
                        rotation=mesh_rotation,
                    )
...
class Regular_cabinet(ConceptTemplate):
    def __init__(
        self,
        number_of_top_cabinet,
        number_of_beneath_cabinet,
        cab_backs_size,
        cab_left_right_inner_sizes,
        cab_up_down_inner_sizes,
        drawer_inner_sizes,
        drawer_bottom_size,
        door_sizes,
        number_of_layers,
        ...
        rotation = [x / 180 * np.pi for x in rotation]
        cabinets_params = [
            x / 180 * np.pi if i % 56 in [22, 23, 24, 25, 41, 42, 43, 44] else x
            for i, x in enumerate(cabinets_params)
        ]
        super().__init__(position, rotation)

        # Record Parameters
        self.number_of_top_cabinet = round(number_of_top_cabinet[0])
        self.number_of_beneath_cabinet = round(number_of_beneath_cabinet[0])
        ...
        for cabinet_idx in range(self.number_of_top_cabinet):
            ...
            cabinet_doors_mesh = sum(
                2
                for type_of_space in self.type_of_spaces[cabinet_idx]
                if type_of_space == 2
            )
            cabinet_drawers_mesh = sum(
                (5 + self.drawer_number_of_handles[cabinet_idx][space_idx])
                for space_idx, type_of_space in enumerate(
                    self.type_of_spaces[cabinet_idx]
                )
                if type_of_space == 1
            )
            total_mesh_list = [
            ...
            for mesh_idx in range(sum(total_mesh_list[:2])):
                if mesh_idx < sum(total_mesh_list[:1]):
                    ...
                    if mesh_idx < 2:
                        mesh_position = [
                            ...
                            * (
                                ...
                                - self.cab_left_right_inner_sizes[cabinet_idx]
                            )
                            / 2
                            + self.cabinet_offset[cabinet_idx][0],
                            self.cabinet_offset[cabinet_idx][1]
                            - self.cabinet_size[cabinet_idx][1] / 2,
                            self.cabinet_offset[cabinet_idx][2],
                        ]
                        self.mesh = Cuboid(
                            self.cabinet_size[cabinet_idx][1],
                            self.cab_left_right_inner_sizes[cabinet_idx],
                        ...
                        mesh_position = [
                            ...
                            * (
                                self.cabinet_size[cabinet_idx][1]
                                - self.cab_up_down_inner_sizes[cabinet_idx]
                            )
                            / 2
                            + self.cabinet_offset[cabinet_idx][1]
                            - self.cabinet_size[cabinet_idx][1] / 2,
                        ...
                        self.mesh = Cuboid(
                            self.cab_up_down_inner_sizes[cabinet_idx],
                            self.cabinet_size[cabinet_idx][0]
                            - 2 * self.cab_left_right_inner_sizes[cabinet_idx],
                            self.cabinet_size[cabinet_idx][2],
                            position=mesh_position,
                        )
                    else:
                    ...
                    mesh_position = [
                        self.cabinet_offset[cabinet_idx][0],
                        -(
                            self.layers_offset[cabinet_idx]
                            + (mesh_idx - sum(total_mesh_list[:1]))
                            * self.interval_between_layers[cabinet_idx]
                        )
                        - self.cabinet_size[cabinet_idx][1] / 2,
                        self.cabinet_offset[cabinet_idx][2],
                    ]
                    self.mesh = Cuboid(
                        self.layers_sizes[cabinet_idx],
                        self.cabinet_size[cabinet_idx][0]
                        - 2 * self.cab_left_right_inner_sizes[cabinet_idx],
                        self.cabinet_size[cabinet_idx][2],
                        position=mesh_position,
                ...
                if self.number_of_top_cabinet == 2:
                    if cabinet_idx % 2 == 0:
                        self.mesh.vertices[:, 0] += (
                            self.cabinet_size[cabinet_idx][0] / 2
                        )
                    else:
                        self.mesh.vertices[:, 0] -= (
                            self.cabinet_size[cabinet_idx][0] / 2
            ...
            for space_idx in range(self.number_of_layers[cabinet_idx] + 1):
                if self.number_of_layers[cabinet_idx] == 0:
                    _height = (
                        self.cabinet_size[cabinet_idx][1]
                        - 2 * self.cab_up_down_inner_sizes[cabinet_idx]
                    )
                    _pos = 0
                elif space_idx == 0:
                    _height = (
                        self.layers_offset[actual_idx]
                        - self.cab_up_down_inner_sizes[cabinet_idx]
                        - self.layers_sizes[cabinet_idx] / 2
                    )
                    _pos = (
                        self.cabinet_size[cabinet_idx][1]
                        - self.layers_offset[actual_idx] / 2
                        - self.cab_up_down_inner_sizes[cabinet_idx] / 2
                        + self.layers_sizes[cabinet_idx] / 4
                    )
                elif space_idx == self.number_of_layers[cabinet_idx]:
                    _height = (
                        self.cabinet_size[cabinet_idx][1]
                        - (
                            self.layers_offset[1]
                            + (space_idx - 1) * self.interval_between_layers[1]
                        )
                        - self.cab_up_down_inner_sizes[cabinet_idx]
                        - self.layers_sizes[cabinet_idx] / 2
                    )
                    ...
                    _height = (
                        self.interval_between_layers[0] - self.layers_sizes[cabinet_idx]
                    )
                    _pos = (
                        self.cabinet_size[cabinet_idx][1]
                        - self.layers_offset[actual_idx]
                        - (2 * space_idx - 1) / 2 * self.interval_between_layers[0]
                    )

                if self.type_of_spaces[cabinet_idx][space_idx] == 1:
                    for mesh_idx in range(
                        5 + round(self.drawer_number_of_handles[cabinet_idx][space_idx])
                    ):
                        if mesh_idx < 2:
                            position_sign = -1 if mesh_idx == 0 else 1
                            mesh_position = [
                                ...
                                * (
                                ...
                                + self.drawer_interval[cabinet_idx][space_idx] / 2,
                            ]
                            self.mesh = Cuboid(
                                _height,
                                self.drawer_inner_sizes[0],
                                self.cabinet_size[cabinet_idx][2]
                                - self.drawer_interval[cabinet_idx][space_idx],
                                position=mesh_position,
                            )
                        elif mesh_idx < 4:
                            position_sign = -1 if mesh_idx == 3 else 1
                            ...
                            mesh_position = [
                                ...
                                _pos
                                + self.cabinet_offset[cabinet_idx][1]
                                - (_height + self.drawer_bottom_size[0]) / 2
                                - self.cabinet_size[cabinet_idx][1] / 2,
                                self.cabinet_offset[cabinet_idx][2]
                                + self.drawer_interval[cabinet_idx][space_idx] / 2
                                + self.drawer_offset[cabinet_idx][space_idx],
                            ...
                            if (
                                self.drawer_number_of_handles[cabinet_idx][space_idx]
                                == 2
                            ):
                            ...
                            mesh_rotation = [
                                0,
                                0,
                                self.drawer_handles_rotation[cabinet_idx][space_idx],
                            ]
                            mesh_position = [
                                self.cabinet_offset[cabinet_idx][0]
                                + self.drawer_handles_offsets[cabinet_idx][space_idx][0]
                                + position_sign
                                * self.drawer_handles_separation[cabinet_idx][
                                    space_idx
                                ],
                                _pos
                                + self.cabinet_offset[cabinet_idx][1]
                                + self.drawer_handles_offsets[cabinet_idx][space_idx][1]
                                - self.cabinet_size[cabinet_idx][1] / 2,
                                self.cabinet_offset[cabinet_idx][2]
                                + (
                                    self.cabinet_size[cabinet_idx][2]
                                    + self.drawer_handles_size[cabinet_idx][2]
                                )
                                / 2
                                + self.drawer_offset[cabinet_idx][space_idx],
                            ]
                            self.mesh = Cuboid(
                                self.drawer_handles_size[cabinet_idx][1],
                                self.drawer_handles_size[cabinet_idx][0],
                                self.drawer_handles_size[cabinet_idx][2],
                                position=mesh_position,
                                rotation=mesh_rotation,
                            )
                    ...
                    for mesh_idx in range(2):
                        if mesh_idx == 0:
                            ...
                            mesh_rotation = [
                                0,
                                0,
                                self.door_handles_rotation[cabinet_idx][space_idx],
                            ]
                            mesh_position = [
                                self.cabinet_offset[cabinet_idx][0]
                                + self.door_handles_offsets[cabinet_idx][space_idx][0],
                                _pos
                                + self.cabinet_offset[cabinet_idx][1]
                                + self.door_handles_offsets[cabinet_idx][space_idx][1],
                                self.cabinet_offset[cabinet_idx][2]
                                + (
                                    self.cabinet_size[cabinet_idx][2]
                                    + self.door_sizes[0]
                                ...
                                / 2
                                + (
                                    self.door_handles_size[cabinet_idx][2]
                                    + self.door_sizes[0]
                                )
                                / 2,
                            ]
                            self.mesh = Cuboid(
                                self.door_handles_size[1],
                                self.door_handles_size[0],
                                self.door_handles_size[2],
                                position=mesh_position,
                                rotation=mesh_rotation,
                            )
                    # special case for top and beneath cabinet to adjust the position of the cabinet
        ...
        for cabinet_idx in range(self.number_of_beneath_cabinet):
                ...
                if mesh_idx < sum(total_mesh_list[:1]):
                    ...
                    if mesh_idx < 2:
                        mesh_position = [
                            ...
                            * (
                                self.cabinet_size[cabinet_idx][0]
                                - self.cab_left_right_inner_sizes[actual_idx]
                            )
                            / 2
                            + self.cabinet_offset[cabinet_idx][0],
                            self.cabinet_offset[cabinet_idx][1],
                        ...
                        mesh_position = [
                            ...
                            * (
                                self.cabinet_size[cabinet_idx][1]
                                - self.cab_up_down_inner_sizes[actual_idx]
                            )
                            / 2
                            + self.cabinet_offset[cabinet_idx][1],
                            self.cabinet_offset[cabinet_idx][2],
                        ...
                        self.mesh = Cuboid(
                            self.cab_up_down_inner_sizes[actual_idx],
                            self.cabinet_size[cabinet_idx][0]
                            - 2 * self.cab_left_right_inner_sizes[actual_idx],
                            self.cabinet_size[cabinet_idx][2],
                            position=mesh_position,
                        )
                    else:
                    ...
                    mesh_position = [
                        ...
                        - (
                            self.layers_offset[actual_idx]
                            + (mesh_idx - sum(total_mesh_list[:1]))
                            * self.interval_between_layers[actual_idx]
                        ),
                        self.cabinet_offset[cabinet_idx][2],
                    ]
                    self.mesh = Cuboid(
                        self.layers_sizes[actual_idx],
                        self.cabinet_size[cabinet_idx][0]
                        - 2 * self.cab_left_right_inner_sizes[actual_idx],
                        self.cabinet_size[cabinet_idx][2],
                        position=mesh_position,
            ...
            for space_idx in range(self.number_of_layers[actual_idx] + 1):
                if self.number_of_layers[actual_idx] == 0:
                    _height = (
                        self.cabinet_size[cabinet_idx][1]
                        - 2 * self.cab_up_down_inner_sizes[actual_idx]
                    )
                    ...
                    _height = (
                        self.layers_offset[actual_idx]
                        - self.cab_up_down_inner_sizes[actual_idx]
                        - self.layers_sizes[actual_idx] / 2
                    )
                    _pos = (
                        self.cabinet_size[cabinet_idx][1]
                        - self.layers_offset[actual_idx] / 2
                        - self.cab_up_down_inner_sizes[actual_idx] / 2
                        + self.layers_sizes[actual_idx] / 4
                    )
                    ...
                    _height = (
                        ...
                        - (
                            self.layers_offset[actual_idx]
                            + (space_idx - 1) * self.interval_between_layers[0]
                        )
                        - self.cab_up_down_inner_sizes[actual_idx]
                        - self.layers_sizes[actual_idx] / 2
                    )
                    ...
                    _height = (
                        self.interval_between_layers[0] - self.layers_sizes[actual_idx]
                    )
                    _pos = (
                        self.cabinet_size[cabinet_idx][1]
                        - self.layers_offset[actual_idx]
                ...
                if self.type_of_spaces[cabinet_idx][space_idx] == 1:
                        ...
                        if mesh_idx < 2:
                            ...
                            mesh_position = [
                                ...
                                * self.drawer_handles_separation[cabinet_idx][
                                ...
                                _pos
                                + self.cabinet_offset[cabinet_idx][1]
                                + self.drawer_handles_offsets[cabinet_idx][space_idx][
                                    1
                                ],
                                self.cabinet_offset[cabinet_idx][2]
                                + (
                    ...
                    for mesh_idx in range(2):
                        if mesh_idx == 0:
                            ...
                            self.mesh = Cuboid(
                                self.door_handles_size[cabinet_idx][1],
                                self.door_handles_size[cabinet_idx][0],
                                self.door_handles_size[cabinet_idx][2],
                                position=mesh_position,
                                rotation=mesh_rotation,
                            )
...
class Regular_partition(ConceptTemplate):
    def __init__(
        ...
        if has_partition[0] == 1:
            mesh_position = [
                left_right_separation[0] / 2 + left_right_size[0] / 2,
                left_right_size[1] / 2,
                0,
            ]
            self.mesh = Cuboid(
        ...
        if has_partition[1] == 1:
            mesh_position = [
                0,
                rear_size[0] / 2,
                -left_right_size[2] / 2 - rear_size[1] / 2,
            ]
            self.mesh = Cuboid(
                rear_size[0],
                left_right_separation[0] + 2 * left_right_size[0],
                rear_size[1],
                position=mesh_position,
            )
            vertices_list.append(self.mesh.vertices)

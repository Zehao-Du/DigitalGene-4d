...
class Regular_drawer_Knowledge(KnowledgeWrapper):
    ...
    def __init__(self, concept, category, manipulation_knowledge, *manip_args):
        ...
        self.force_direction = np.array([0, 0, 1])  # pull
        ...
        if obj.number_of_handle[drawer_idx] == 2:
            ...
            position_sign = 0
        mesh_rotation = [0, 0, handle_rotation[drawer_idx]]
        mesh_position = [
            drawer_offset[drawer_idx][0]
            + handle_offset[drawer_idx][0]
            + position_sign * handle_separation[drawer_idx] / 2,
            -drawer_size[drawer_idx][1] / 2
            + drawer_offset[drawer_idx][1]
            + handle_offset[drawer_idx][0],
...
class Regular_door_Knowledge(KnowledgeWrapper):
    ...
    def __init__(self, concept, category, manipulation_knowledge, *manip_args):
        ...
        mesh_rotation = [0, door_rotation[door_idx], handle_rotation[door_idx]]
        mesh_position = [
            ...
            door_offset[door_idx][1]
            - door_size[door_idx][1] / 2
            + handle_offset[door_idx][1],

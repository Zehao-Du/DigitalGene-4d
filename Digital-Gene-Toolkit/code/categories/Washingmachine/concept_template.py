...
class Front_Facing_Roller_Body(ConceptTemplate):
    def __init__(
        ...
        bottom_mesh_position = [0, 0, -inner_size[1] / 2]
        self.bottom_mesh = Cuboid(
            outer_size[1],
            outer_size[0],
            outer_size[2] - inner_size[1],
        ...
        top_mesh_position = [0, 0, (outer_size[2] - inner_size[1]) / 2]
        self.top_mesh = Box_Cylinder_Ring(
            outer_size[1],
            outer_size[0],
            inner_size[1],
            inner_size[0],
...
class Cuboidal_Body(ConceptTemplate):
    def __init__(self, outer_size, thickness, position=[0, 0, 0], rotation=[0, 0, 0]):
        ...
        bottom_mesh_position = [0, -(outer_size[1] - thickness[2]) / 2, 0]
        self.bottom_mesh = Cuboid(
            thickness[2], outer_size[0], outer_size[2], position=bottom_mesh_position
        )
        vertices_list.append(self.bottom_mesh.vertices)
        faces_list.append(self.bottom_mesh.faces + total_num_vertices)
        total_num_vertices += len(self.bottom_mesh.vertices)

        top_mesh_position = [0, thickness[2] / 2, 0]
...
class Roller_Door(ConceptTemplate):
    def __init__(
        ...
        middle_mesh_position = [circle_size[0], 0, circle_size[2] / 2]
